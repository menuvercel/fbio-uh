...
import { mallaMicrobiologia, Asignatura } from '@/data/mallasMicrobiologia';
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className={`${cormorant.className} text-gray-600`}>
                Plan de estudios vigente para la Licenciatura en Microbiología y Virología
              </p>
            </div>
            <div className="mt-4 md:mt-0 flex space-x-2">
              ...
              <a
                href="/docs/malla-microbiologia.pdf"
                download
        ...
        <div className="bg-white p-6 rounded-xl shadow-md mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className={`${cormorant.className} text-lg font-medium text-gray-900`}>{totalHoras}</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className={`${cormorant.className} text-lg font-medium text-gray-900`}>{totalAsignaturas}</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className={`${cormorant.className} text-sm text-gray-500 mb-1`}>Última Actualización</p>
              <p className={`${cormorant.className} text-lg font-medium text-gray-900`}>2021</p>
            </div>
          </div>
        </div>
        ...
        {/* Malla Curricular */}
        <div className="bg-white p-6 rounded-xl shadow-md mb-8">
          <MallaCurricular planEstudio={mallaMicrobiologia} carrera="Microbiología y Virología" />
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="space-y-4">
            <p className={`${cormorant.className} text-gray-700`}>
              Para obtener el grado de Licenciado(a) en Microbiología y Virología, 
            ...
            <div className="bg-gray-50 p-5 rounded-lg">
              <ol className={`${cormorant.className} space-y-3 list-decimal pl-5 text-gray-700`}>
                <li>Aprobar la totalidad de las asignaturas del plan de estudios (Plan E 2021).</li>
                <li>Completar satisfactoriamente el Trabajo de Laboratorio Básico (1er año).</li>
                <li>Realizar y aprobar las Prácticas de Microbiología Clínica (2do año).</li>
                <li>Completar las Prácticas de Virología (3er año).</li>
            ...
            <p className={`${cormorant.className} text-gray-700`}>
              ...
              orientar su formación según sus intereses profesionales en áreas como microbiología industrial, 
              virología molecular, biotecnología microbiana o microbiología ambiental. Las asignaturas optativas disponibles 
              se ofertan semestralmente y abarcan diferentes áreas de especialización en microbiología y virología.
            </p>
            <p className={`${cormorant.className} text-gray-700 mt-4`}>
              ...
              y habilidades prácticas en el campo de la microbiología y virología, con énfasis en la investigación 
              y el desarrollo de soluciones biotecnológicas para problemas de salud y ambiente.
            </p>
          </div>
        </div>
